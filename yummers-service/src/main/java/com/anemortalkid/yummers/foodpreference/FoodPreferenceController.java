...
public class FoodPreferenceController {
	...
	public YummersResponseEntity<List<Associate>> associatesWithBreakfast() {
		...
		List<Associate> breakfast = foodPreferences.parallelStream().map(fp -> fp.getAssociate())
	...
	public YummersResponseEntity<List<Associate>> associatesWithoutPreference() {
		...
		List<Associate> associates = associateController.getAllAssociates();
	...
	public YummersResponseEntity<FoodPreference> setFoodPreference(String callingPath, String associateId,
		...
		Associate foundAssociate = associateController.findById(associateId);
	...
	public void removePreferenceForAssociate(Associate associateToUnregister) {
		FoodPreference existingPreference = foodPreferenceRepository.findByAssociate(associateToUnregister);
		if (existingPreference != null) {
			foodPreferenceRepository.delete(existingPreference);
		}
	}
